...
public class JispyTest {
    ...
    public void lambdaTest1() {
        assertEquals(120, Jispy.evalScripts("(fact 5)"));
    }
    ...
    public void callccTest() {
        assertEquals(35, Jispy.evalScripts("(call/cc (lambda (throw) (+ 5 (* 10 " +
                "(call/cc (lambda (escape) (* 100 (escape 3))))))))"));
        assertEquals(3, Jispy.evalScripts("(call/cc (lambda (throw) " +
    ...
    public void lispyTest(){
        assertEquals(treeList(new Symbol("testing"), 1, treeList(2.0), -3.14E159),evalScripts("(quote (testing 1 (2.0) -3.14e159))"));
        ...
        assertEquals(treeList(treeList(1,5),treeList(2,6),treeList(3,7),treeList(4,8)),evalScripts("(zip (list 1 2 3 4) (list 5 6 7 8))"));
        ...
        assertEquals(treeList(1,2,3,4,5,6,7,8), evalScripts("(riff-shuffle (riff-shuffle (riff-shuffle (list 1 2 3 4 5 6 7 8))))"));
